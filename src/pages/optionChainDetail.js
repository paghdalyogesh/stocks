...
import OptionChainDetailCom from '../components/equityDerivatives/optionChainDetailCom'

class OptionChainDetail extends Component {
  constructor(props) {
    super(props);
      ...
      <div className="rows">
        ...
        <div className="row m-0 p-0">
          <div className="col mt-md-2 m-0 p-0">
            <OptionChainDetailCom pages={this.state.jobFilter.page} list={list} handlerFromParant={this.handleData} />
          </div>
        </div>
        <Footer />
      </div>
...
export default connect(mapStatetoProps, mapDispatchToProps)(OptionChainDetail);
